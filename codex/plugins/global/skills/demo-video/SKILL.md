...
For non-trivial work, run the heavy phases through a small agent team per the global agents rule, but
the **approval gate** (the storyboard) happens in the main thread with User.
